...
int main ()
{
    ...
    // using t1 = append_n< append_n< list<>, 3, Rat<2,1> >::type, 2, Rat< 1,4 > >::type;
    // using t2 = append_n< append_n< list<>, 3, Rat<1,2> >::type, 2, Rat< 2,3 > >::type;
    using t1 = Rat<2,1>;
    using t2 = Rat<1,4>;
    cout << t1() << " + " << t2()
    ...
    using l1 = append_n< append_n< list<>, 3, Rat<2,1> >::type, 2, Rat< 1,4 > >::type;
    using l2 = append_n< append_n< list<>, 3, Rat<1,2> >::type, 2, Rat< 2,3 > >::type;
